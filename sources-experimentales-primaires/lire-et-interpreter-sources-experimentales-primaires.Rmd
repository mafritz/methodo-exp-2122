...
abstract: |
  Ce document propose des informations utiles pour s'initier à la lecture et interprétation de contributions expérimentales *primaires*, c'est-à-dire réportant l'ensemble du processus de génération, récolte, et analyse de données expérimentale. La première partie du document aborde la structure *standard* des contributions expérimentales primaires : Introduction, Méthode, Résultats, et Discussion. La deuxième partie introduit une méthode systèmatique pour lire, interpréter et éventuellement planifier une recherche expérimentale : la méthode QALMRI, acronyme de Question, Alternatives, Logique, Méthode, Résultats et Inférences.
---
...
L'acronyme QALMRI correspond aux 6 critères d'analyse d'une contribution expérimentale : *Questions, Alternatives, Logic, Method, Results and Inferences*. Les mots qui compose l'acronyme sont très proches au français, ce qui permet de le garder sans la nécessité de convertir des lettres : Questions, Alternatives, Logique, Méthode, Résultats et Inférences.
